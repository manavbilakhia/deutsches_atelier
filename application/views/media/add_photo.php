...
<div class="content">
	<div class="col-md-12">
		<div  class="card">
			...
			<div class="card-header"><legend>Add Photos</legend></div>
			<div class="card-body">
				<div class="col-md-6">
					...
					<input type="file" name="files" value="" class="form-control flat" placeholder="Select files"accept=".jpg,.jpeg,.png,.svg,.gif" />
					<input type="hidden" name="type" value="photo" />
					<br/>
					<a href="index.php?/media/photos" class="btn btn-warning flat pull-right" style="margin-left:10px;">Cancel</a>
					<input type="submit" value="Add Photo" class="btn flat btn-primary pull-right">
				</div>
