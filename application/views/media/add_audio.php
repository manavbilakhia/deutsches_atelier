...
<div class="content">
	<div class="col-md-12">
		<div  class="card">
			...
			<div class="card-header"><legend>Add Audio</legend></div>
			<div class="card-body">
				<div class="col-md-6">
					...
					<input type="file" name="files" value="" class="form-control flat" placeholder="Select files" accept=".mp3,.aac,.m4a,.wav" />
					<input type="hidden" name="type" value="document" />
					<br/>
					<a href="index.php?/media/audios" class="btn btn-warning flat pull-right" style="margin-left:10px;">Cancel</a>
					<input type="submit" value="Add Audio" class="btn flat btn-primary pull-right">
				</div>
